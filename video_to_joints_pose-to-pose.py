  ...
  while cap.isOpened():
    ...
    if results.left_hand_landmarks != None and results.right_hand_landmarks != None and results.pose_landmarks != None:
        ...
        if send_midi_bool:
            ...
            if my_n_elbow_scale_values < 3 and near_elbow_flip_status_b != 1:
                midiout.send_message([0x90, center_wrist_near, 100])
                near_elbow_flip_status_b = 1
                time.sleep(my_delay)
            elif my_n_elbow_scale_values >= 3 and near_elbow_flip_status_b != 2:
                midiout.send_message([0x90, center_wrist_near, 100])
                near_elbow_flip_status_b = 2
                time.sleep(my_delay)
            ...
            if my_f_elbow_scale_values < 3 and far_elbow_flip_status_b != 1:
                time.sleep(my_delay)
                midiout.send_message([0x90, center_wrist_far, 100])
                far_elbow_flip_status_b = 1
            elif my_f_elbow_scale_values >= 3 and far_elbow_flip_status_b != 2:
                time.sleep(my_delay)
                midiout.send_message([0x90, center_wrist_far, 100])
                far_elbow_flip_status_b = 2
